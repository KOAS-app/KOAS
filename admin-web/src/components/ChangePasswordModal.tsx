        ...
        <div className="px-6 py-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  name="current"
                  className="w-full px-4 py-3 border border-[#d1d5db] rounded-lg bg-white text-[#111827] text-sm outline-none transition-all placeholder:text-[#9ca3af] hover:border-[#9ca3af] focus:border-[#3b82f6] focus:ring ring-[#3b82f6]/20 disabled:bg-[#f9fafb] disabled:text-[#6b7280] disabled:cursor-not-allowed pr-11"
                  placeholder="••••••••"
                  value={form.current}
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                type="submit"
                className="flex-1 px-4 py-2.5 rounded-lg text-sm font-semibold text-white bg-[#3b82f6] border border-[#3b82f6] shadow-sm shadow-[#3b82f6]/20 transition-all hover:bg-[#1e40af] hover:shadow-md hover:shadow-[#3b82f6]/30 active:translate-y-px disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-2"
